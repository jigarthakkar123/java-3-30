	...
	<div class="row">
		...
		<h4>Latest Products </h4>
			  <ul class="thumbnails">
				...
				<li class="span3">
				  <div class="thumbnail">
					<a href="product_details.jsp"><img src="product_images/<%=p.getProduct_image() %>" alt="" style="width: 200px;height: 200px;"/></a>
					<div class="caption">
					  ...
					  <a href="seller-product-details.jsp?pid=<%=p.getPid()%>"><input type="button" value="Details"  class="btn btn-primary"></a>
					</div>
				  </div>
				</li>
				<%} %>
