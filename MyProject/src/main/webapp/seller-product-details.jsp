					...
					<div class="row">
						<div id="gallery" class="span3">
							<a href="themes/images/products/large/f1.jpg"
								...
								src="product_images/<%=p.getProduct_image()%>"
								...
								<div class="carousel-inner">
									<div class="item active">
										<a href="themes/images/products/large/f1.jpg"> <img
											style="width: 29%"
											src="product_images/<%=p.getProduct_image()%>" alt="" /></a> <a
											href="themes/images/products/large/f2.jpg"> <img
											style="width: 29%"
											src="product_images/<%=p.getProduct_image()%>" alt="" /></a> <a
											href="themes/images/products/large/f3.jpg"> <img
											style="width: 29%"
											src="product_images/<%=p.getProduct_image()%>" alt="" /></a>
									</div>
									<div class="item">
										<a href="themes/images/products/large/f3.jpg"> <img
											style="width: 29%"
											src="product_images/<%=p.getProduct_image()%>" alt="" /></a> <a
											href="themes/images/products/large/f1.jpg"> <img
											style="width: 29%"
											src="product_images/<%=p.getProduct_image()%>" alt="" /></a> <a
											href="themes/images/products/large/f2.jpg"> <img
											style="width: 29%"
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<a href="login.jsp"><button type="button"
											class="btn btn-large btn-primary pull-right">Login</button></a>

									<%
									} else {
									%>
									<a
										href="seller-edit-product.jsp?pid=<%=p.getPid()%>&uid=<%=u.getUid()%>"><button
											type="button" class="btn btn-large btn-primary pull-right">
											EDIT <i class=" icon-edit"></i>
										</button></a> <a
										href="seller-delete-product.jsp?pid=<%=p.getPid()%>&uid=<%=u.getUid()%>"><button
											type="button" class="btn btn-large btn-danger pull-right">
											...
											<div class="row">
												...
												<div class="span4">
													...
													<a class="btn btn-small pull-right"
														href="product_details.jsp">View Details</a> <br
														class="clr" />
												</div>
													...
													<form class="form-horizontal qtyFrm">
														...
														<div class="btn-group">
															<a href="product_details.jsp"
																...
																href="product_details.jsp" class="btn btn-large"><i
