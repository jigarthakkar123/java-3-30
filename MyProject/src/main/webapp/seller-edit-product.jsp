...
<div id="mainBody">
	...
	<%
		...
		Product p=ProductDao.getProductByUser(pid, uid);
	...
	<input type="hidden" name="pid" value="<%=p.getPid()%>">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="inputFname1" value="<%=p.getProduct_name() %>" name="product_name">
			</div>
		 </div>
		 <div class="control-group">
			<label class="control-label" for="inputLnam">Product Price <sup>*</sup></label>
			<div class="controls">
			  <input type="text" id="inputLnam" value="<%=p.getProduct_price() %>" name="product_price">
			</div>
		 </div>
	  ...
	  <div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="address" value="<%=p.getProduct_desc() %>" name="product_desc"/> 
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
	...
	<div class="control-group">
			<div class="controls">
				...
				<input class="btn btn-large btn-success" type="submit" name="action" value="Update Product" />
			</div>
		</div>		
	</form>
</div>
